...
EnvelopeBox::EnvelopeBox(Envelope *envelope, QWidget *parent)
    : QGroupBox(parent), envelope(envelope), envelopeLabel(this),
      attackSelect(this), attackLabel(this), decaySelect(this),
      decayLabel(this), sustainSelect(this), sustainLabel(this),
      releaseSelect(this), releaseLabel(this) {
  ...
  QObject::connect(&attackSelect, SIGNAL(valueChanged(int)), this,
                   SLOT(setAttack(int)));
  QObject::connect(&attackSelect, SIGNAL(valueChanged(int)), this,
                   SLOT(setFocus()));

  QObject::connect(&decaySelect, SIGNAL(valueChanged(int)), this,
                   SLOT(setDecay(int)));
  QObject::connect(&decaySelect, SIGNAL(valueChanged(int)), this,
                   SLOT(setFocus()));

  QObject::connect(&sustainSelect, SIGNAL(valueChanged(int)), this,
                   SLOT(setSustain(int)));
  QObject::connect(&sustainSelect, SIGNAL(valueChanged(int)), this,
                   SLOT(setFocus()));

  QObject::connect(&releaseSelect, SIGNAL(valueChanged(int)), this,
                   SLOT(setRelease(int)));
  QObject::connect(&releaseSelect, SIGNAL(valueChanged(int)), this,
                   SLOT(setFocus()));
}
