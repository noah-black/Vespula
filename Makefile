...
# Generated by qmake (2.01a) (Qt 4.8.1) on: Sun Jan 6 05:22:34 2013
# Project:  synth.pro
# Template: app
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/synth1.0.0/ && $(COPY_FILE) --parents chorus.h envelope.h envelopebox.h envelopeconnection.h fm.h fmbox.h keyboard.h lfo.h lfoable.h lfobox.h lfoconnection.h looper.h lpf.h modulatable.h modulator.h modulatorlistener.h note.h notefactory.h oscillator.h oscillators.h soundmanager.h soundprocessor.h synthesizer.h vibrato.h vibratobox.h waveformcombobox.h wavetable.h .tmp/synth1.0.0/ && $(COPY_FILE) --parents chorus.cpp envelope.cpp envelopebox.cpp envelopeconnection.cpp fm.cpp fmbox.cpp keyboard.cpp lfo.cpp lfoable.cpp lfobox.cpp lfoconnection.cpp looper.cpp lpf.cpp main.cpp modulator.cpp note.cpp notefactory.cpp oscillator.cpp oscillators.cpp soundmanager.cpp synthesizer.cpp vibrato.cpp vibratobox.cpp waveformcombobox.cpp wavetable.cpp .tmp/synth1.0.0/ && (cd `dirname .tmp/synth1.0.0` && $(TAR) synth1.0.0.tar synth1.0.0 && $(COMPRESS) synth1.0.0.tar) && $(MOVE) `dirname .tmp/synth1.0.0`/synth1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/synth1.0.0
...
compiler_moc_header_make_all: moc_envelopebox.cpp moc_fmbox.cpp moc_lfobox.cpp moc_synthesizer.cpp moc_vibratobox.cpp moc_waveformcombobox.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc_envelopebox.cpp moc_fmbox.cpp moc_lfobox.cpp moc_synthesizer.cpp moc_vibratobox.cpp moc_waveformcombobox.cpp
