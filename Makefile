...
# Generated by qmake (2.01a) (Qt 4.8.1) on: Tue Sep 18 13:53:02 2012
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/synthesizer1.0.0/ && $(COPY_FILE) --parents chorus.h fm.h keyboard.h looper.h lpf.h note.h sawtooth.h sine.h soundprocessor.h square.h synthesizer.h triangle.h vibrato.h .tmp/synthesizer1.0.0/ && $(COPY_FILE) --parents chorus.cpp fm.cpp keyboard.cpp looper.cpp lpf.cpp main.cpp note.cpp sawtooth.cpp sine.cpp square.cpp synthesizer.cpp triangle.cpp vibrato.cpp .tmp/synthesizer1.0.0/ && (cd `dirname .tmp/synthesizer1.0.0` && $(TAR) synthesizer1.0.0.tar synthesizer1.0.0 && $(COMPRESS) synthesizer1.0.0.tar) && $(MOVE) `dirname .tmp/synthesizer1.0.0`/synthesizer1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/synthesizer1.0.0
