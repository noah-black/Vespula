...
# Generated by qmake (2.01a) (Qt 4.8.1) on: Sat Dec 29 00:23:54 2012
# Project:  synth.pro
# Template: app
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/synth1.0.0/ && $(COPY_FILE) --parents chorus.h envelopebox.h envelope.h fm.h fmbox.h keyboard.h looper.h lpf.h note.h sawtooth.h sine.h soundeffect.h soundmanager.h soundprocessor.h square.h synthesizer.h triangle.h vibrato.h vibratobox.h .tmp/synth1.0.0/ && $(COPY_FILE) --parents chorus.cpp envelopebox.cpp envelope.cpp fm.cpp fmbox.cpp keyboard.cpp looper.cpp lpf.cpp main.cpp note.cpp sawtooth.cpp sine.cpp soundmanager.cpp square.cpp synthesizer.cpp triangle.cpp vibrato.cpp vibratobox.cpp .tmp/synth1.0.0/ && (cd `dirname .tmp/synth1.0.0` && $(TAR) synth1.0.0.tar synth1.0.0 && $(COMPRESS) synth1.0.0.tar) && $(MOVE) `dirname .tmp/synth1.0.0`/synth1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/synth1.0.0
...
moc_envelopebox.cpp: keyboard.h \
		triangle.h \
		note.h \
		soundprocessor.h \
		sawtooth.h \
