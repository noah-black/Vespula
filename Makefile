...
# Generated by qmake (2.01a) (Qt 4.8.1) on: Fri Dec 21 14:48:02 2012
# Project:  synth.pro
# Template: app
...
CFLAGS        = -m64 -pipe -O2 -Wall -W -D_REENTRANT -g $(DEFINES)
CXXFLAGS      = -m64 -pipe -O2 -Wall -W -D_REENTRANT -g $(DEFINES)
